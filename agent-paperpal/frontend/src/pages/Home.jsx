                        ...
                        <div className="flex flex-col h-full gap-8">
                            ...
                            <div className="mt-auto pt-4">
                                <button
                                    ...
                                    tabIndex={0}
                                    aria-disabled={!file || !style || loading}
                                ...
                                <p className="mt-4 text-center text-xs text-slate-400 font-medium">Secure upload · HIPAA/GDPR Compliant · SOC2 Type II Pipeline</p>
                            </div>
                        </div>
                    </div>
                </div>
